...
<summary>Whats in the scope for Dijkstra era hard fork?</summary>
...
The hard fork working group meetings are in the shared [Luma Calendar](https://luma.com/calendar/cal-TMjYNpSY4huYYif). The [Cardano Upgrades GitBook](https://cardanoupgrades.docs.intersectmbo.org/) contains important hard fork context, working group policies, readiness tracking, and working group meeting minutes.
...
<summary>How will the Dijkstra era hard fork be previewed and tested before full deployment?</summary>

Node with protocol version 12 will be previewed and tested on [preview and pre-production testnets](https://docs.cardano.org/cardano-testnets/environments/). This process is controlled by the community, ensuring thorough testing and validation before the full deployment.
...
<summary>What is the role of stake pool operators upgrading to the latest node for the Dijkstra era hard fork?</summary>

Stake Pool Operators play an important (the most important!) part in any hard fork. The community requires them to upgrade prior to a hard fork combinator event. The latest status of SPOs' readiness can be found on our [Dijkstra Upgrade Readiness page](https://cardanoupgrades.docs.intersectmbo.org/van-rossem-upgrade/dijkstra-upgrade-readiness).
