...
**Estimated hard fork enactment** <mark style="color:$danger;">17th June</mark> ([tentative timeline](https://app.excalidraw.com/s/6GdMPTId7vW/1xnslUPryZP))

| Workstream                                                                                                                                                       | RAG status | Last update                                                            |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ---------------------------------------------------------------------- |
| [Core Infrastructure Components](https://cardanoupgrades.docs.intersectmbo.org/van-rossem-upgrade/van-rossem-upgrade-readiness#core-infrastructure-components)   | 🔴         | **24th Feb:** Hard fork ready release 10.7.0 expected within 1-2 weeks |
