...
2. [Node 11.0.1](https://github.com/IntersectMBO/cardano-node/releases/tag/11.0.1) & [DBSync 13.7.0.5](https://github.com/IntersectMBO/cardano-db-sync/releases/tag/13.7.0.5) - Sam/Ramsay/Jeff
   1. 13.7.0.x/13.7.0.5 with fix/workaround
   2. 13.7.1.0
...
4. van Rossem hard fork progress - Bosko
   1. PreProd
      ...
      3. Are we ready to vote, ratify and enact hf ga on preprod? (first next possible enactment date is **31st May** if its voted for until **26th May** - epoch boundary on PreProd)
   2. Mainnet
      1. Set the new mainnet hard fork initiation governance action submission date
5. Plutus Cost Model - Kevin, Ryan, Bosko
   1. Mainnet - submitted on 22nd May
      1. mincommittee size parameter update governance action expected to be submitted on 29th May, at the epoch boundary
