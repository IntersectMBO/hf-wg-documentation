...
Dependent on scope. Here you will find high level timeline overview of the steps needed for Dijkstra era hard fork to happen by the end of 2026.

## Notes

Dijkstra: Scope, Timing, Priorities, Process
...
* CIP 112 out of treasury proposal
...
* Haskell, Dingo, Amaru
* Dependency list
* Someone mentioned doing something like this for coordinating messaging/direction: [https://forkcast.org/](https://forkcast.org/)
