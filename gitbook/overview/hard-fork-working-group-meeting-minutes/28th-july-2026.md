...
2. Van Rossem Upgrade Update - Bosko, Sam, Can
   ...
   2. Engineering team is nevertheless doing the investigation into what made first block in the HF so slow to be produced - Alexey
3. [Dijkstra era hard fork](https://cardanoupgrades.docs.intersectmbo.org/dijkstra-era/dijkstra-overview) - Bosko, all
   1. Hard fork naming
      1. Naming it after Alexander Esgen, with adding In Memoriam section to eternalize others who sadly passed away in recent months/years
